...
object SqlUtil {
    ...
    fun insertSql(table: String, columnNames: Array<String>, values: Array<String>): String {
        return insertSql(table, columnNames.joinToString(), values.joinToString(separator = Constants.Symbol.SINGLE_QUOTE + Constants.Symbol.COMMA + Constants.Symbol.SINGLE_QUOTE, prefix = Constants.Symbol.SINGLE_QUOTE, postfix = Constants.Symbol.SINGLE_QUOTE))
    }
