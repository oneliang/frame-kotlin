...
object CollectUtil {
    ...
    fun collectFromHttpWithCache(
        ...
        return this.collectFromHttpWithCache(
            httpUrl,
            method,
            cacheKey,
            httpHeaderList,
            ...
            cacheRefreshTime,
            collectRuleList,
            object : CollectDataTransformer<List<CollectData>> {
