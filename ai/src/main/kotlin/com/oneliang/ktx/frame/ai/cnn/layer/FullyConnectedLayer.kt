...
open class FullyConnectedLayer<IN : Any, OUT : Any, LOSS : Any>(
    ...
    private val updateImpl: ((layer: FullyConnectedLayer<IN, OUT, LOSS>, epoch: Int, printPeriod: Int, totalDataSize: Long, learningRate: Float) -> Unit)? = null,
