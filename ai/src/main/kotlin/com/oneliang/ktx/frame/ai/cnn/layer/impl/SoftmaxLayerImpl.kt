...
open class SoftmaxLayerImpl(neuronCount: Int, typeCount: Int) : SoftmaxLayer<Array<Double>, Array<Double>>(neuronCount, typeCount) {
    ...
    override fun backwardImpl(dataId: Long, inputNeuron: Array<Double>, y: Double) {
        val nextLayerLoss = (this.nextLayer!! as OutputLayerImpl).loss
