...
class SoftmaxRegressionLayer<IN : Any, OUT : Any>(
    ...
    private val updateImpl: ((layer: SoftmaxRegressionLayer<IN, OUT>, epoch: Int, printPeriod: Int, totalDataSize: Long, learningRate: Double, training: Boolean) -> Unit)? = null,
