...
private fun test() {
    var totalWeight = 0.0
    "C:/Users/Administrator/Desktop/2021_06_21_default_problem.log".toFile().readContentIgnoreLine { line ->
...
fun main() {
    ...
    "C:/Users/Administrator/Desktop/a.csv".toFile().readContentIgnoreLine { line ->
