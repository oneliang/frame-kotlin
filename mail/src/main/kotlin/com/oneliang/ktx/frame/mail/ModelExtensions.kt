...
fun Message.addRecipient(toAddress: ToAddress) {
    ...
    when (type) {
        ToAddress.Type.TO -> this.addRecipient(Message.RecipientType.TO, address)
        ToAddress.Type.BCC -> this.addRecipient(Message.RecipientType.BCC, address)
        ToAddress.Type.CC -> this.addRecipient(Message.RecipientType.CC, address)
    }
}
